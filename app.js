...
const ICO = "0x36Bf56020334CA983F7A5957Bb5e95abe5F6FA5c"; 
const TRC = "0xA355D186C6019BE07ED383309FD1d1c194Bfd06F";
...
if (customPriceInput && customPriceInput > 0) {
  ...
  currentPrice = Number(
    ...
    // BUY TAX (1%)
    // ==============================
    const effectiveInvestment = dailyInvestment * 0.99;
    ...
    // Total effective sell tax = 2%
    const netValue = grossValue * 0.98;
    ...
    const dailyNetSell = dailyGrossSell * 0.98;
...
while (balance > 0.00001 && day < 1000) {
  ...
  // If balance < 1000 TRC → fixed 10 TRC
  if (balance < 1000) {
    sellTRC = 10;
  }
